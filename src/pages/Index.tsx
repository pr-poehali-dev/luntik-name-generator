...
const CHARACTERS = [
  ...
  },
  {
    ...
    color: "#10b981",
    bgColor: "#f0fdf4",
    description: "Две гусеницы-близняшки, которые обожают пакостить и разыгрывать всех вокруг. Их проделки бывают весьма изощрёнными, а смех после удачной шутки слышен на весь лес. Несмотря на вредность, они делают это без злого умысла — просто очень любят веселиться.",
    traits: ["Пакостницы", "Хитрые", "Весёлые"],
  },
  {
