...
const CHARACTERS = [
  ...
  },
  {
    ...
    color: "#f97316",
    bgColor: "#fff7ed",
    description: "Лучший друг Лунтика — гусеница-оптимист с огромным аппетитом. Кузя всегда весел, немного ленив, но очень предан своим друзьям. Он обожает поесть и поспать, однако ради Лунтика готов на любые приключения. Его непосредственность и юмор поднимают настроение всем вокруг.",
    traits: ["Весёлый", "Оптимист", "Верный друг"],
  },
  {
    name: "Мила",
    emoji: "🦋",
    color: "#ec4899",
    bgColor: "#fdf2f8",
    description: "Красивая и добрая бабочка, которая стала одной из первых подруг Лунтика. Мила отзывчива, заботлива и всегда готова поддержать в трудную минуту. Она очень любит цветы и природу. Порой бывает немного кокетлива, но это лишь придаёт ей шарм.",
  ...
  },
  {
    ...
    color: "#84cc16",
    bgColor: "#f7fee7",
    description: "Мудрая и добрая бабушка Лунтика — гусеница в очках с огромным опытом жизни. Бабуля терпелива, всегда даёт мудрые советы и воспринимает шалости внука с улыбкой. Её дом всегда открыт для друзей, а истории из прошлого полны мудрости и доброты.",
    traits: ["Мудрая", "Терпеливая", "Добросердечная"],
  },
  {
    name: "Дедуля",
    emoji: "🐌",
    color: "#0ea5e9",
    bgColor: "#f0f9ff",
    description: "Дедушка Лунтика — спокойная и рассудительная улитка. Он медлителен, но невероятно мудр. Дедуля знает ответы почти на все вопросы и любит рассказывать поучительные истории. Его неспешность порой контрастирует с энергией Лунтика, что создаёт забавные ситуации.",
    traits: ["Мудрый", "Спокойный", "Рассудительный"],
  },
  {
    name: "Шнюк и Шняк",
    emoji: "🦎",
    color: "#ef4444",
    bgColor: "#fff1f2",
    description: "Братья-пакостники, которые постоянно строят козни Лунтику и его друзьям. Несмотря на вредность, они трусоваты и часто попадают впросак из-за собственных проделок. Иногда в них просыпается совесть, и они помогают другим — пусть и нехотя.",
    traits: ["Хитрые", "Задиристые", "Трусоватые"],
  },
  {
    name: "Вупсень и Пупсень",
    emoji: "🐸",
    color: "#10b981",
    bgColor: "#f0fdf4",
    description: "Братья-лягушата, которые обожают петь и устраивать переполох. Громкие, задорные и немного нахальные, они превращают любое событие в настоящее шоу. Несмотря на шумный характер, они искренни и по-своему добросердечны.",
    traits: ["Шумные", "Весёлые", "Артистичные"],
  },
  {
    name: "Корней Корнеич",
    emoji: "🌳",
    color: "#78716c",
    bgColor: "#fafaf9",
    description: "Мудрый и строгий кот, живущий в лесу. Он знает множество правил и законов природы и не стесняется делиться ими с окружающими. Порой кажется суровым, но на самом деле заботится о порядке и благополучии всех обитателей леса.",
    traits: ["Строгий", "Мудрый", "Справедливый"],
  },
  {
    name: "Тётя Мотя",
    emoji: "🐱",
    color: "#d97706",
    bgColor: "#fffbeb",
    description: "Добродушная и немного суетливая кошка — соседка Лунтика. Она любит порядок в своём доме и очень переживает, когда что-то идёт не по плану. Несмотря на строгость, она по-настоящему добрая и всегда угостит вкусным.",
    traits: ["Хлопотливая", "Добродушная", "Гостеприимная"],
  },
];
