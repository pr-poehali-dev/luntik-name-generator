...
const CHARACTERS = [
  ...
  },
  {
    ...
    color: "#8b5cf6",
    bgColor: "#f5f3ff",
    description: "Добрая старая паучиха — бабушка Шнюка, которая живёт очень далеко и не может навестить внука. Зато она регулярно присылает ему по почте гостинцы: варенье, вязаные вещи и записки с тёплыми словами. Когда Шнюк был совсем маленьким, именно она спасла его во время грозы — успела вытащить из-под падающего дерева. Шнюк до сих пор помнит это и бережно хранит каждую посылку от бабули.",
    traits: ["Заботливая", "Добрая", "Далёкая, но родная"],
  },
  {
    name: "Пескарь Иванович",
    emoji: "🐟",
    color: "#0369a1",
    bgColor: "#f0f9ff",
    description: "Старый важный пескарь, живущий в пруду неподалёку от тёти Моти. Пескарь Иванович всегда носит монокль и считает себя весьма образованным и интеллигентным. Он говорит медленно, с достоинством, и очень не любит, когда его перебивают. С тётей Мотей у них давняя дружба — они часами могут молчать рядом, и оба считают это прекрасной беседой.",
    traits: ["Важный", "Интеллигентный", "С моноклем"],
  },
  {
    name: "Пиявка",
    emoji: "🪱",
    color: "#64748b",
    bgColor: "#f8fafc",
    description: "Вечно недовольная обитательница пруда. У Пиявки всегда найдётся повод для жалобы: то вода слишком холодная, то слишком тёплая, то соседи шумят, то слишком тихо. Она жалуется с утра до вечера и искренне не понимает, как остальные могут быть довольны жизнью. Впрочем, если кому-то действительно плохо — она первая окажется рядом, хоть и продолжая ворчать.",
    traits: ["Недовольная", "Ворчливая", "Жалобщица"],
  },
  {
    name: "Тяпсень",
    emoji: "🐛",
    color: "#3b82f6",
    bgColor: "#eff6ff",
    description: "Троюродный брат Вупсеня — и его полная противоположность. Внешне Тяпсень очень похож на Вупсеня, вот только его ободок на голове и тапочки ярко-синие. Тяпсень никогда не пакостит — он всегда занят добрыми делами: поможет донести тяжёлое, подбодрит расстроенного, уступит место. Спокойный и дружелюбный, он немного теряется рядом с шумным Вупсенем.",
    traits: ["Добрый", "Спокойный", "Отзывчивый"],
  },
  {
    name: "Ляпсень",
    emoji: "🐛",
    color: "#2563eb",
    bgColor: "#dbeafe",
    description: "Троюродный брат Пупсеня, и внешне очень на него похожий — такой же круглый и добродушный. Отличить Ляпсеня от Пупсеня можно по синей кепке и синим тапочкам. В отличие от брата, Ляпсень тратит время не на шалости, а на добрые поступки: угощает всех вкусностями, которые сам и готовит, и никогда не откажет в помощи.",
    traits: ["Добродушный", "Щедрый", "Добросердечный"],
  },
];
